...
ColumnsToRemove = c("seeking continuing education", "continuing education", "not seeking employment", "NA")

data_filtered <- data %>%
  filter(data$survey_plans != ColumnsToRemove)

unique(data_filtered$survey_plans)
```
Remove unnecessary columns

Fix text issues (OH=ohio=oh=Ohio)

Look at missing (drop row if needed)

Look at outliers (drop row if needed)
